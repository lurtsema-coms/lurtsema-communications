  ...
  <div id="nav-list" class="flex-grow hidden lg:inline">
    <div class="flex flex-col items-start justify-between flex-grow gap-5 my-5 lg:flex-row lg:mt-5 lg:mb-0 lg:ml-5">
      <ul class="flex flex-col gap-5 lg:flex-row lg:items-end lg:gap-12 lg:ml-5">
        ...
        <li><a class="text-decoration-none text-nowrap hover:opacity-75" href="{{ url('/#services') }}">Services</a>
        </li>
        <li><a class="text-decoration-none text-nowrap hover:opacity-75" href="{{ route('contact-us') }}">Contact</a>
        </li>
      ...
      <div class="flex flex-col gap-5 lg:flex-row">
        {{-- <a href="{{ route('contact-us') }}"
          class="flex flex-row items-center justify-center rounded-full text-nowrap hover:opacity-75 lg:bg-slate-200 lg:text-black lg:font-bold lg:px-3 lg:py-1">
          Get In Touch
        ...
        {{-- <a href="https://client-portal.lurtsemacommunications.com/" id="client-portal-btn" target="_blank"
          class="flex flex-row items-center justify-center rounded-full text-nowrap hover:opacity-75 lg:bg-slate-200 lg:text-black lg:font-bold lg:px-3 lg:py-1">
          Client Portal
